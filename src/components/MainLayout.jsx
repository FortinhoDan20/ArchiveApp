    ...
    <Layout>
      ...
      <div className="logo">
          <h2 className="text-white fs-5 text-center py-3 mb-0">
            ...
            <span className="lg-logo">Archive Docs</span>
          </h2>
        </div>
        <Menu
          theme="dark"
          ...
          items={[
            ...
            {
              key: "Mail",
              icon: <AiFillDiff className="fs-4" />,
              label: "Couriers",
              children: [
                {
                  key: "mail-shipped",
                  icon: <AiFillFileAdd className="fs-4" />,
                  label: "Courier Expédier",
                },
                {
                  key: "mail-received",
                  icon: <AiFillFileAdd className="fs-4" />,
                ...
                {
                  key: "list-mail-received",
                  icon: <CiBoxList className="fs-4" />,
                  label: "Liste Reçu",
                },
                {
                  key: "list-mail-shipped",
                  icon: <CiBoxList className="fs-4" />,
                  label: "Liste expédiée ",
                },
          ...
          <div className="d-flex gap-4 align-items-center">
            ...
            <div className="d-flex gap-3 align-items-center dropdown">
              ...
              <div
                ...
                aria-expanded="false"
              >
                <h5 className="mb-0">Dan Fortinho</h5>
